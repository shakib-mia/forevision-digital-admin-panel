...
const UploadSection = ({ setProgress, setProgressVisible }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 pr-7">
            ...
            <Select placeholder="Select Platform Name" options={options ? options.map(item => item.cat_name) : []} selectedValue={selectedValue} setSelectedValue={setSelectedValue} />

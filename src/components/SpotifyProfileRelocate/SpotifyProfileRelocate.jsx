      ...
      <table className="w-full">
        ...
        <tbody>
          {data.map((item, id) => (
            ...
            >
              <td className="py-2">{item.spotify_fresh_profile_name}</td>
              <td className="py-2">{item.spotify_fresh_profile_email}</td>
                ...
                item !== "_id" && (
                  <tr className="divide-x">
                    <th className="capitalize py-2">
                      {item.split("spotify_fresh_profile_")[1].includes("_")
                        ? item
                            .split("spotify_fresh_profile_")[1]
                            .split("_")
                            .join(" ")
                        : item.split("spotify_fresh_profile_")[1]}
                    </th>

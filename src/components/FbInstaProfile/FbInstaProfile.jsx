...
const FbInstaProfile = () => {
  ...
  const handleApprove = () => {
    ...
    axios
      .put(backendUrl + "submit-form/fb-insta-profile/" + _id, rest)
      .then(() => {
        Swal.fire({
          icon: "success",
          title: "Approved",
          text: "The Facebook Instagram Profile Link Request has been approved.",
        });
        setRefetch(!refetch);
      ...
      axios
        ...
        .then(() => {
          Swal.fire({
            ...
            text: "The Facebook Instagram Profile Link Request has been denied.",
          });
          setRefetch(!refetch);
          setDetailsId(-1); // Close the modal
        })
      ...
      <table className="w-full">
        ...
        <tbody>
          {data.map((item, id) => (
            ...
            >
              <td className="py-2">{item.songName}</td>
